...
GetInspectionReportModel getInspectionReportModelFromJson(String str) => GetInspectionReportModel.fromJson(json.decode(str));

String getInspectionReportModelToJson(GetInspectionReportModel data) => json.encode(data.toJson());
...
class GetInspectionReportModel {
    ...
    factory GetInspectionReportModel.fromJson(Map<String, dynamic> json) => GetInspectionReportModel(
        status: json["status"],
